...
\lfoot{
  ...
  \,\hfill {\footnotesize \textcolor{gray}{updated August 2014~~~~~}} \hfill\,
}
...
\item[\mydot]
I currently work as a design engineer at KONE. I'm working closely with motors and everything related to motor control
such as AC drives and encoders.

\item[\mydot]
I am interested in programming and open source. 
Nowadays I spent significant time developing mobile applications and most of my projects are mobile related. 
Alongside that I'm also focusing on computer vision/image processing and how to apply them on my new ideas. 
I constantly try to improve my skills and learn new things whether it's related to some programming language or 
an open-source scientific computing tool. 
...
\smalltopic{Skills}{
  ...
  \begin{itemize}[leftmargin=0ex, itemsep=0ex, labelindent=-2ex, parsep=.5ex]
    \item[\mydot] +8 years experience with MATLAB
    \item[\mydot] +4 years experience with Qt/QML and C++
    \item[\mydot] Experience with bash, \LaTeX{}, HTML5, CSS3, PHP, SQLite, jQuery, Fortran.
    \item[\mydot] Scripting: Python, JavaScript
    \item[\mydot] Technologies: OpenCV, Boost, OpenMP, MPI, PyQt, NumPy, SciPy, Matplotlib
    \item[\mydot] Tools: GCC, LLVM/Clang, git, Doxygen
    \item[\mydot] Operating systems: Linux (Ubuntu), Windows 7/8 and Sailfish OS
  \end{itemize}
